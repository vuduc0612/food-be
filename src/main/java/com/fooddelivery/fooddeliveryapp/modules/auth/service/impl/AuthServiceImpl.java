package com.fooddelivery.fooddeliveryapp.modules.auth.service.impl;
...
import com.fooddelivery.fooddeliveryapp.exception.EntityExistsException;
import com.fooddelivery.fooddeliveryapp.exception.ForbiddenException;
import com.fooddelivery.fooddeliveryapp.exception.InvalidCredentialsException;
...
import com.fooddelivery.fooddeliveryapp.modules.otp.service.OtpService;
...
import com.fooddelivery.fooddeliveryapp.security.UserPrincipal;
import com.fooddelivery.fooddeliveryapp.utils.JwtTokenProvider;
...
public class AuthServiceImpl implements AuthService {
    ...
    public RegisterResponse register(RegisterDto registerDto, RoleType roleType) {
        ...
        Account account;
        if (roleType.equals(RoleType.ROLE_RESTAURANT)) {
            if (existingAccount.isPresent()) {
                throw new EntityExistsException("Account already has restaurant role: " + email);
            }
            account = new Account();
