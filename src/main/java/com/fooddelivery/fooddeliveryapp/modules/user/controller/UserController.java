package com.fooddelivery.fooddeliveryapp.modules.user.controller;
...
import com.fooddelivery.fooddeliveryapp.modules.user.dto.RestaurantDto;
...
//
//        UserResponseDto updatedUser = res.updateUser(id, restaurantDto);
//        return ResponseEntity.ok(
//                ResponseObject.builder()
//                        .message("Update user successfully")
//                        .data(updatedUser)
