package com.fooddelivery.fooddeliveryapp.modules.restaurant.repostitory;
...
public interface RestaurantRepository extends JpaRepository<Restaurant, Long> {
    ...
    @Query("""
            SELECT DISTINCT new com.fooddelivery.fooddeliveryapp.modules.restaurant.dto.RestaurantResponseDto(
