package com.fooddelivery.fooddeliveryapp.modules.restaurant.controller;

import com.fooddelivery.fooddeliveryapp.constant.RoleType;
import com.fooddelivery.fooddeliveryapp.modules.auth.dto.RegisterDto;
...
import com.fooddelivery.fooddeliveryapp.modules.restaurant.service.RestaurantService;
...
public class RestaurantController {
    ...
    @PostMapping("/upload-image-v2")
    public ResponseEntity<ResponseObject> uploadImageV2(
            @RequestParam("file") MultipartFile file
    ) throws IOException {
    ...
    //Update restaurant
    @PutMapping("/v2")
    public ResponseEntity<ResponseObject> updateRestaurantV2(
            @RequestBody RestaurantDto restaurantDto) {
        Long id = authService.getCurrentRestaurant().getId();
        RestaurantDto restaurant = restaurantService.updateRestaurant(id, restaurantDto);
